            ...
            <div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
                <div class="input-group searchbox">
                    <div class="input-group-btn">
                        <center><a href="include/find_friends.php"><button class="btn btn-default search-icon" name="search_user" type="submit">Add new users</button></a></center>
                    </div>
                </div>
                <div class="left-chat">
                    <ul>
                     ...
                     <div class="col-md-12 right-header">
                        ...
                        <div class="right-header-detail">
                            <form method="post">
                                 ...
                                 <span><?php echo $total; ?> message </span>&nbsp; &nbsp;
                    ...
                    <ul>
                        <?php
                            if($user_name ==$sender_username AND $username==$reciever_username){
                                ...
                                <span>$user_name &nbsp;
                                <small style='color: red;'>$msg_date</small></span>
                                <p>$msg_content</p>
                                </div>
                                </li>
                                ";
